...
export const collections = {
  ...
  settings: () => col<Document>(COLLECTIONS.settings),
  adminAudit: () => col<AdminAuditDoc>(COLLECTIONS.adminAudit),
  sessions: () => col<SessionDoc>(COLLECTIONS.sessions),
  signIns: () => col<SignInDoc>(COLLECTIONS.signIns),
  uploadLogs: () => col<UploadLogDoc>(COLLECTIONS.uploadLogs),
  chatReports: () => col<ChatReportDoc>(COLLECTIONS.chatReports),
  assistantLog: () => col<AssistantLogDoc>(COLLECTIONS.assistantLog),
  syncState: () => col<SyncStateDoc>(COLLECTIONS.syncState),
};
