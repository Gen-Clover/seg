...
export const GRID_COLS: GridCol[] = [
  ...
  { key: "laydownEstimate", label: "Laydown estimate", width: 112, kind: "estimate", field: "laydownEstimate" },
  { key: "sixMonthEstimate", label: "6-month estimate", short: "Including laydown", width: 112, kind: "estimate", field: "sixMonthEstimate" },
